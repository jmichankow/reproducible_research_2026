...
For inline output in Positron try `Cmd+,` and search for 'quarto inline', enable it.

Rendering with rmd `rmarkdown::render("RR_7_markdown.Rmd", output_format = "pdf_document")`
