...
Deadline for this assignment is 10.05 and you will get 2 points for it (if done properly).

Remeber about our Generative AI rules (use it only for minor help with the task and clearly mark any sections that were generated) as it will be checked during this task.
